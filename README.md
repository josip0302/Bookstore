...
u mom slučaju je to bilo localhost:8080.
Potrebno je inicijalizirati projekt klijenta unosom naredbe npm install u terminal i onda se može pokrenuti pokreatnjem naredbe npm run dev u terminalu na adresi unutar samog direktorija bookstore_client.
